          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <li><a href="listBoard.do">공지사항</a></li>
                <li><a href="list.food">상품정보</a></li>
                <li class="active"><a href="sortkw.food">베스트 섭취 정보</a></li>
    ...
    <div><p><img src="resources/images/총메인.PNG"  id="MAIN_image"></p><br><br>
      	...
      	<table >
				...
				<td align=center bgcolor=white> 
					<a href="detail.food?code=${c.code }"><img src="resources/${c.img }"  id="first_image" /></a>
					<td align=center bgcolor=white> <font color="black" size="10">${c.code }</font></td>
					<td align=center bgcolor=white> <font color="black" size="5">
					<a href="detail.food?code=${c.code }"><font color="black" size="5">${c.name }</a></font></font>
					</td>
					<td align=center bgcolor=white> <font color="black" size="5">1일 칼로리 양: ${c.supportpereat }</font></td>
			
					<td align=center bgcolor=white> <font color="black" size="5">칼로리 : ${c.calory }</font></td>
			
					<td align=center bgcolor=white> <font color="black" size="5">탄수화물 : ${c.carbo }</font></td> 
					</tr>
				</c:forEach>
		</table>
		</div> 
