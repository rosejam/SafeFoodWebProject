...
/*	public FoodPageBean(String key, String word, String pagelink, int pageNo) {
	...
	public FoodPageBean(String key, String[] words, String pagelink, int pageNo) {
		setKey(key);
		setWords(words);
		setPagelink(pagelink);
		setPageNo(pageNo);
	}
	public FoodPageBean(String key, String[] words, String pagelink, String pageNo) {
		setKey(key);
		setWords(words);
		setPagelink(pagelink);
		setPageNo(pageNo);
...
/*	public String getWord() {
	...
	public String toString() {
		...
		builder.append("PageBean [key=").append(key).append(", words=").append(Arrays.toString(words)).append(", pagelink=").append(pagelink)
				.append(", pageNo=").append(pageNo).append(", interval=")
				.append(interval).append(", start=").append(start)
				.append(", end=").append(end).append("]"); //.append(", word=").append(word)
